...
?>
				...
				<td><img src="<?php echo $Foto?>" alt="<?php echo $data["Foto"]; ?>"></td>
...
<div id="Buttom">
	<ul>
	<li><a href="ACEPTAR_RENTAS.php"> Consultar rentas. </a></li>
	<li><a href="ACEPTAR_RENTAS.php"> Agregar producto. </a></li>
	</ul>	
	</div>
